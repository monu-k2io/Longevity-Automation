...
APP_INSTALL_WITHOUT_CMD = f"docker run -itd -e JAVA_TOOL_OPTIONS='-Xms100m -Xmx600m' -p {APP_PORT}:8080 --name {APP_CONTAINER_NAME} k2cyber/test_application:{APP_CONTAINER_NAME}"
