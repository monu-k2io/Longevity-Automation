...
APP_INSTALL_WITH_CMD = f"docker run --net=host -v /opt/k2root:/opt/k2root:z -e K2_GROUP_NAME={K2.K2_GROUP_NAME} -itd -p 8080:8080 --name {APP_CONTAINER_NAME} k2cyber/test_application:syscall_node_v16_with"
APP_INSTALL_WITHOUT_CMD = f'docker run --net=host -itd -p 8080:8080 --name {APP_CONTAINER_NAME} k2cyber/test_application:syscall_node_v16_without'
