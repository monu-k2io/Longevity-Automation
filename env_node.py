...
K2_INSTALL_CMD = "bash /root/installer/k2install/k2install.sh -i micro-agent"
APP_INSTALL_WITH_CMD = "docker run -v /opt/k2root:/opt/k2root:z -e K2_OPTS='--require /opt/k2root/k2root/collectors/k2-njs-agent' -e K2_GROUP_NAME=IAST -itd -p 8080:8080 --name syscall_node k2cyber/test_application:k2-node-vulnerable-per-v16"
