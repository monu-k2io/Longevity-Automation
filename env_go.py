...
APP_INSTALL_WITH_CMD = f"docker run -itd -v /opt/k2root:/opt/k2root -p 8084:8084 -e K2_GROUP_NAME={K2.K2_GROUP_NAME} --name {APP_CONTAINER_NAME} k2cyber/test_application:{APP_CONTAINER_NAME}"
