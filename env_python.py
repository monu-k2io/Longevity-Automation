...
APP_INSTALL_WITH_CMD = f"docker run -v /opt/k2root:/opt/k2root:z -e K2_OPTS='-m k2_python_agent' -e PYTHONPATH=/opt/k2root/k2root/collectors/k2-python-agent/lib/site-packages -e K2_GROUP_NAME={K2.K2_GROUP_NAME} -itd -p 8000:8000 --name syscalls_python k2cyber/test_application:syscalls_python"
